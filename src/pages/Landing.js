        ...
        <div>
          {recoilState.username ? (
            <h2 style={{ color: 'white', fontWeight: '600', fontSize: '2rem' }}>
              Welcome <span style={{ color: '#ff385c' }}>{recoilState.username}</span>!
            </h2>
          ) : (
            <>
              <h2 style={{ color: 'white', fontWeight: '600', fontSize: '2rem' }}>
                Join <span style={{ color: '#ff385c' }}>{count.user}</span> other users worldwide!
              </h2>
              <p className='text-center' style={{ color: 'white' }}>
                Add to our growing collection of <span style={{ color: '#ff385c' }}>{count.song}</span> songs.
              </p>
            </>
          )}
        </div>
      ...
      {recoilState.username ? null : (
        ...
        >
          <Container className='p-2 m-auto rounded-lg'>
            <h1 style={{ fontSize: '4vw', fontWeight: '700' }} className='text-center'>
              Create a Free Account Today
            </h1>
            <p className='text-center'>Post your music taste, for the world to see!</p>
            <CreateAccount />
          </Container>
        </div>
      )}
